...
public class CalculateTwoNumber extends JFrame {
	...
	public CalculateTwoNumber() {
		...
		textNumber1.setBounds(162, 9, 96, 19);
		...
		chOparator.setBounds(162, 88, 48, 21);
		chOparator.addItem("+");
		chOparator.addItem("-");
		chOparator.addItem("*");
		chOparator.addItem("/");
		...
		chckbxShowResult.setBounds(162, 177, 230, 21);
